    ...
    <b-container>
      <b-row class="align-items-center mb-4 mb-md-6">
        <b-col md="6" class="mb-3 mb-md-0">
          <h2 class="mb-0">Kenapa Memilih Kami</h2>
        </b-col>
      ...
      >
        <SwiperSlide>
          <b-card no-body class="bg-primary p-5 mt-lg-7">
            <b-card-header class="bg-transparent d-flex justify-content-between p-0 pb-6">
              <h5 class="me-4 mb-0">
                <a href="#" class="stretched-link heading-color">Berpengalaman lebih dari 15 tahun</a>
              </h5>
              <router-link
                to="#"
                class="btn btn-round btn-light border flex-shrink-0 flex-centered"
              >
                <BIconArrowUpRight />
              </router-link>
            </b-card-header>
            ...
            <b-card-body class="p-0">
              ...
              <p class="fw-semibold heading-color mb-0 mt-2">
                Kami telah berpengalaman lebih dari 15 tahun dalam bidang ini
              </p>
            </b-card-body>
          </b-card>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <b-card no-body class="bg-dark p-5 mt-lg-4" data-bs-theme="dark">
            <b-card-header class="bg-transparent d-flex justify-content-between p-0 pb-6">
              <h5 class="me-4 mb-0">
                <a href="#" class="stretched-link">Proses Yang Cepat</a>
              </h5>
              <a href="#" class="btn btn-round btn-light border flex-shrink-0 flex-centered">
                <BIconArrowUpRight />
              </a>
            </b-card-header>
            ...
            <b-card-body class="p-0">
              ...
              <p class="fw-semibold heading-color mb-0 mt-2">
                Proses yang kami lakukan cukup dari 5 sampai 10 menit
              </p>
            </b-card-body>
          </b-card>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <b-card no-body class="bg-light border p-5">
            <b-card-header class="bg-transparent d-flex justify-content-between p-0 pb-6">
              <h5 class="me-4 mb-0">
                <a href="#" class="stretched-link">Berbagai macam pembayaran</a>
              </h5>
              <a href="#" class="btn btn-round btn-white border flex-shrink-0 flex-centered">
                <BIconArrowUpRight />
              </a>
            </b-card-header>
            ...
            <b-card-body class="p-0">
              ...
              <p class="fw-semibold heading-color mb-0 mt-2">
                Kami menerima berbagai macam pembayaran, mulai dari transfer bank, gopay, ovo, dan lainnya
              </p>
            </b-card-body>
          </b-card>
        </SwiperSlide>
